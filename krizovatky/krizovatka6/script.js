...
window.onload = function nastavAutaNaPozicie() {
    ...
    modreauto.style.marginTop = "146px";
    modreauto.style.marginLeft = "645px";
    ...
    zlteauto.style.marginTop = "392px";
    zlteauto.style.marginLeft = "445px";
    zlteauto.style.transform = "rotate(-70deg)";
...
function motionPath2() {
    ...
    cerveneauto.style.marginLeft = "-60px";
